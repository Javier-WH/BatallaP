...
import teacherAdminHourRoutes from '@/routes/teacherAdminHourRoutes';
import teacherWorkloadRoutes from '@/routes/teacherWorkloadRoutes';
import scheduleRoutes from '@/routes/scheduleRoutes';
import scheduleExceptionRoutes from '@/routes/scheduleExceptionRoutes';
import scheduleLinkRoutes from '@/routes/scheduleLinkRoutes';
